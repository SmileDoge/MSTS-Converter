...
using TrainSim.Parsers;

namespace TrainSim.Formats
{
    public class SFile
    {
        public shape shape;
    ...
    public struct distance_levels_header
    {
        public int DlevBias;
    ...
    public struct distance_level_header
    {
    ...
    public struct sub_object_header
    {
